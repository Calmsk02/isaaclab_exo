...
from .msk_isaac_marl_env_cfg import MskIsaacMarlEnvCfg


class MskIsaacMarlEnv(DirectMARLEnv):
    cfg: MskIsaacMarlEnvCfg

    def __init__(self, cfg: MskIsaacMarlEnvCfg, render_mode: str | None = None, **kwargs):
